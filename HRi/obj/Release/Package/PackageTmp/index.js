...
(function () {
    ...
    document.write("<script type='text/javascript' src='/Infinity/AUNQA/GUI/JScript/Dictionary.js?ver=" + ver + "'><\/script>");
    ...
    .controller("hriSearchCtrl", function ($rootScope, $scope, $timeout, $q, $compile, $filter, NgTableParams, utilServ, appServ) {
        var self = this;
    ...
    .controller("hriPersonalInformationCtrl", function ($timeout, $q, utilServ, appServ) {
        var self = this;
